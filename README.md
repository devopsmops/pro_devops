# PRO DevOps
Collection of links from the [@devops_mops](https://t.me/devops_mops) telegram channel
...
- [AWS Meetup Terraform & Terragrunt. Антон Бабенко (2020)](https://habr.com/ru/post/523014/)
- [Terraformer — Infrastructure To Code](https://habr.com/ru/post/450410/)
- [AWS re:Invent - AWS Provider for Terraform deep dive](https://www.youtube.com/watch?v=-Ce6AguT-1M&ab_channel=HashiCorp)
- [Introducing Atlantis](https://medium.com/runatlantis/introducing-atlantis-6570d6de7281)
- [Infrastructure Automation with Terraform and Atlantis](https://tech.boxed.com/infrastructure-automation-with-terraform-0-12-and-atlantis-1a5725ee247e)
...
- [Используем Terraformer для адаптации действующей инфраструктуры в AWS для деплоев с Terraform](https://habr.com/ru/company/flant/blog/550974/)
